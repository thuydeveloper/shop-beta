        ...
        <div className="space-y-8 lg:flex lg:items-start lg:justify-between">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-5">
              <Link target="_blank" href="https://x.com/thuydeveloper">
                <Icons.Twitter className="w-8 h-8 text-gray-400" />
              </Link>
              <Link
                target="_blank"
                href="https://www.facebook.com/thuy.developer/"
              >
                <Icons.Linkedin className="w-8 h-8 text-gray-400" />
              </Link>
              <Link target="_blank" href="https://www.facebook.com/thuy.developer/">
